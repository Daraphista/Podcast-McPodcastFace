    ...
    <main>
      <section className="px-gutter py-section-default lg:py-28 lg:pt-12 bg-white">
        <div className="max-w-container-default mx-auto space-y-4">
          <div className="p-8 max-w-4xl mx-auto font-sans text-gray-800 leading-relaxed [&_li>p]:inline">
            <h1 className="text-4xl font-bold mb-2 text-center text-gray-900">Privacy Policy</h1>
            ...
            <ul className="list-disc list-inside space-y-4">
              ...
              <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to The Expert&apos;s Voice, 30 North Gould Street St. #37575, Sheridan, WY 82801.</p>
              </li>
              <li>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 border-b-2 pb-2 text-gray-900">Collecting and Using Your Personal Data</h2>
            
            <h3 className="text-xl font-semibold mt-4 mb-2 text-gray-800">Types of Data Collected</h3>
            
            <h4 className="text-lg font-semibold mt-4 mb-2 text-gray-700">Personal Data</h4>
            ...
            <h4 className="text-lg font-semibold mt-4 mb-2 text-gray-700">Usage Data</h4>
            ...
            <h4 className="text-lg font-semibold mt-4 mb-2 text-gray-700">Information from Third-Party Social Media Services</h4>
            ...
            <p className="my-4">If You decide to register through or otherwise grant us access to a Third-Party Social Media Service, We may collect Personal data that is already associated with Your Third-Party Social Media Service&quot;s account, such as Your name, Your email address, Your activities or Your contact list associated with that account.</p>
            <p className="mb-8">You may also have the option of sharing additional information with the Company through Your Third-Party Social Media Service&quot;s account. If You choose to provide such information and Personal Data, during registration or otherwise, You are giving the Company permission to use, share, and store it in a manner consistent with this Privacy Policy.</p>
            
            <h4 className="text-lg font-semibold mt-4 mb-2 text-gray-700">Tracking Technologies and Cookies</h4>
            ...
            <p className="my-4">Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a href="https://www.privacypolicies.com/blog/privacy-policy-template/#Use_Of_Cookies_Log_Files_And_Tracking" target="_blank" className="text-blue-600 hover:text-blue-800 underline">Privacy Policies website</a> article.</p>
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2 text-gray-800">Use of Your Personal Data</h3>
            ...
            <p className="mt-8 mb-4">We may share Your personal information in the following situations:</p>
            <ul className="list-disc list-inside space-y-4">
            ...
            <h3 className="text-xl font-semibold mt-8 mb-2 text-gray-800">Retention of Your Personal Data</h3>
            <p className="mb-4">The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use Your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies.</p>
            <p className="mb-8">The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of Our Service, or We are legally obligated to retain this data for longer time periods.</p>
            
            <h3 className="text-xl font-semibold mt-4 mb-2 text-gray-800">Transfer of Your Personal Data</h3>
            ...
            <p className="mb-8">The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in accordance with this Privacy Policy and no transfer of Your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of Your data and other personal information.</p>
            
            <h3 className="text-xl font-semibold mt-4 mb-2 text-gray-800">Delete Your Personal Data</h3>
            ...
            <p className="mb-8">Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis to do so.</p>
            
            <h3 className="text-xl font-semibold mt-4 mb-2 text-gray-800">Disclosure of Your Personal Data</h3>
            <h4 className="text-lg font-semibold mt-4 mb-2 text-gray-700">Business Transactions</h4>
            ...
            <h4 className="text-lg font-semibold mt-4 mb-2 text-gray-700">Law enforcement</h4>
            ...
            <h4 className="text-lg font-semibold mt-4 mb-2 text-gray-700">Other legal requirements</h4>
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2 text-gray-800">Security of Your Personal Data</h3>
            <p className="mb-8">The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
            
            <h2 className="text-2xl font-bold mt-8 mb-4 border-b-2 pb-2 text-gray-900">Children&quot;s Privacy</h2>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 border-b-2 pb-2 text-gray-900">Changes to this Privacy Policy</h2>
